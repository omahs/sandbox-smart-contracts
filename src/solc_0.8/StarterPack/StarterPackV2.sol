...
contract StarterPackV2 is Admin, MetaTransactionReceiver, PurchaseValidator {
    ...
    function purchaseWithSand(
        ...
        uint256 amountInSand =
            _calculateTotalPriceInSand(message.catalystIds, message.catalystQuantities, message.gemQuantities);
